...
A pistol is a key. 
A golden key is a key.
A universal magnetic pass is a key. Understand "pass" as universal magnetic pass. 

A paper is a kind of thing.
A rice paper is a paper.
A scaly skin is a paper.
A blank page is a paper. 
...
A sharp collarbone is a pen. Understand "bone" as sharp collarbone.
...
A peacock is an animal. The description of the peacock is "A big stuning colorful bird.". A peacock carries feathers. The carrying capacity of the peacock is 1000. 
...
The rounded jar, the skinny jar, and the pear shaped jar are jars on the small altar.
...
Understand the command "read" as something new. Reading is an action applying to one carried thing.
...
A Black Jack table is a thing. A Black Jack table contains a pistol.  
...
Understand the command "play" as something new. Playing is an action applying to one thing.
...
The sharp collarbone is in the Ritual Waste. 


Section 9 - Antarctica  
...
The car contains a universal magnetic pass. 
